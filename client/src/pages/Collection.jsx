          ...
          <div className="text-center py-16 text-slate-500">
            ...
            <p className="font-medium">
              {filter === 'all'
                ...
                : `No ${FORMAT_LABELS[filter]} titles`}
            </p>
                  ...
                  <div className="flex-shrink-0">
                    {item.poster_url ? (
                      <img
                        src={item.poster_url}
                        alt={item.title}
                        className="w-12 h-[4.5rem] object-cover rounded-lg"
                        loading="lazy"
                      />
                    ) : (
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-2 mt-1.5">
                      <span className="text-xs bg-slate-700 text-slate-300 rounded px-1.5 py-0.5 flex items-center gap-1">
                        ...
                        {item.format === 'digital' && item.platform && (
                          <span className="text-slate-500">· {item.platform}</span>
                        )}
                      </span>
                      {item.notes && (
                        <span className="text-xs text-slate-500 truncate">{item.notes}</span>
                      )}
                    </div>
                  </div>
                </div>
