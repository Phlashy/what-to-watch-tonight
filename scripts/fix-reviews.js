...
const updates = [
  ...
  {
    id: 62,
    notes: `Lol, had to watch this after seeing Nouvelle Vague. It was okay. I didn't really get it, after seeing it. (Unlike Battle of Algiers, which I was able to understand its place in the canon after seeing it, and could see its influence immediately.) Had to read some stuff and watch some videos. So now I kind of get it: it has some technical kudos (jump cuts), and it was a response to both the Americanisation of cinema (making fun of film noir and the notion that you just need "a girl and a gun") and rejecting the French cinema that came before it (but that had already been mostly dethroned by Hollywood). I'm glad I saw it but I don't know if I'll ever watch it again.`,
  },

  // id 65 - The President's Cake
  {
    id: 65,
    notes: `Interesting and "Dickensian" tale of a kid in Baghdad trying to get ingredients with no resources. A side of the middle east I have never seen - these little river houses with, essentially, bedouin groups. And everyone had a Saddam mustache!! Enjoyed it.`,
  },

  // id 464 - One Battle After Another
  {
    id: 464,
    notes: `Fun movie. I'm not ready to say it's the most awesomest thing in the world yet but\u2026 A bunch of revolutionaries trying to save the US from fascism. Then there's a baby. And then a bad guy military leader comes after them. With some white nationalists thrown in. Sean Penn playing the bad guy. Interestingly and coincidentally Leo's character is watching Battle of Algiers at a pivotal moment and is quoting it as he watches it.`,
  },

  // id 70 - Lion King 1 and 1/2
  {
    id: 70,
    notes: `It's really quite funny. Mitu was laughing out loud the whole time. Pumba and Timon tell the story of the lion king from their POV.`,
  },
];
